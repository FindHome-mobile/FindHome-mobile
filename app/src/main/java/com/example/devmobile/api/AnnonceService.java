...
public interface AnnonceService {
    ...
    // Routes pour les propriétaires avec authentification
    @Multipart
    @POST("annonces/proprietaire")
    Call<JsonObject> createAnnonceByProprietaire(
        @Part("titre") okhttp3.RequestBody titre,
        @Part("description") okhttp3.RequestBody description,
        @Part("localisation") okhttp3.RequestBody localisation,
        @Part("prix") okhttp3.RequestBody prix,
    ...
    Call<JsonObject> updateAnnonceByProprietaire(
        @Path("annonceId") String annonceId,
        @Part("titre") okhttp3.RequestBody titre,
        @Part("description") okhttp3.RequestBody description,
        @Part("localisation") okhttp3.RequestBody localisation,
        @Part("prix") okhttp3.RequestBody prix,
    ...
    @PATCH("annonces/proprietaire/{annonceId}/status")
    Call<JsonObject> updateStatusByProprietaire(@Path("annonceId") String annonceId, @Body JsonObject body);

    @DELETE("annonces/{annonceId}")
    Call<JsonObject> deleteAnnonceByProprietaire(@Path("annonceId") String annonceId);

    @GET("annonces/proprietaire/{proprietaireId}")
    Call<JsonObject> getAnnoncesByProprietaireWithAuth(@Path("proprietaireId") String proprietaireId);
}
